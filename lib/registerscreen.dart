...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  String urlRegister =
      "http://yjjmappflutter.com/WatchYou/php/register_user.php";
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            TextField(
              style: TextStyle(
                  color: Colors.white, fontFamily: 'Do Hyeon', fontSize: 20),
              controller: _name,
  ...
  void _onRegister() {
    ...
    if ((_isEmailValid(email)) && (password.length > 5) && (phone.length > 5)) {
